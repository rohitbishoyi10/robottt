...
Variables       ../../../../tests/locators/ui/bluerock/bluerock_mysites.py
Variables       ../../../../tests/variables/ui/bluerock/bluerock_mysites.py

*** Keywords ***
Navigate To Mysite Page And Validate
    [Documentation]  Keyword to perform site creation from mysites section
        Wait Until Keyword Succeeds  3x  5s      Wait Until Page Contains Element And Click      ${lnk_mysites_locator}
        Wait Until Page Contains Element And Click      ${txt_create_site_locator}
        Input Text     ${txt_site_name_locator}     ${site_name}
